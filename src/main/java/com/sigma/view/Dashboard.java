...
public class Dashboard {
        ...
        public void show(Stage stage) {
                ...
                Button dashboardBtn = menuButton("⌂", "Dashboard", true);
                ...
                Button appointmentBtn = menuButton("▣", "Appointments", false);
                ...
                appointmentBtn.setOnAction(e -> {
                        ...
                        AppointmentPage appointments = new AppointmentPage();
                ...
                labBtn.setOnAction(e -> {
                        ...
                        LabrecordsPage labPage = new LabrecordsPage();
                ...
                Button emergencyBtn = menuButton(
                                "✚",
                                "Emergency",
                                false);
                ...
                LabrecordsController labController = new LabrecordsController();

                int labReportCount = labController.getAllLabrecords().size();

                AppointmentController appointmentController = new AppointmentController();

                int appointmentCount = appointmentController.getAllAppointments().size();

                // ==========================================
                // TOTAL UNIQUE PATIENTS
                // ==========================================

                List<com.sigma.model.Appointment> allAppointments = appointmentController.getAllAppointments();

                java.util.Set<String> uniquePatients = new java.util.HashSet<>();
                ...
                int totalPatientCount = uniquePatients.size();

                BedBookingController bedBookingController = new BedBookingController();

                int bedBookingCount = bedBookingController.getAllBedBookings().size();
                ...
                VBox appointmentPanel = createAppointmentPanel();

                VBox bedPanel = createBedPanel();
                ...
                VBox labPanel = createLabPanel();

                VBox emergencyPanel = createEmergencyPanel();
                ...
                Scene scene = new Scene(
                                root, scenesettings.rectanguler2d.getWidth(),
        ...
        private HBox createHeader(Stage stage) {
                ...
                HospitalAdminProfileController profileController = new HospitalAdminProfileController();

                HospitalAdminProfile profile = profileController.getHospitalAdminProfile();
                ...
                List<Notification> unreadNotifications = notificationController.getUnreadNotifications();
                ...
                final StackPane badge = new StackPane();
                ...
                StackPane adminLogo = new StackPane(
                                avatar,
                                adminIcon);
        ...
        private VBox createAppointmentPanel() {
                ...
                TableColumn<Appointment, String> doctor = new TableColumn<>("Doctor");

                TableColumn<Appointment, String> time = new TableColumn<>("Time");

                TableColumn<Appointment, String> status = new TableColumn<>("Status");
                ...
                List<com.sigma.model.Appointment> appointments = appointmentController.getAllAppointments();
        ...
        private VBox createBedPanel() {
                ...
                BedBookingController controller = new BedBookingController();

                List<BedBooking> bookings = controller.getAllBedBookings();
                ...
                // Percentages
                double availablePercentage = totalBedCount == 0
                                ? 0
                                : (availableCount * 100.0)
                                                / totalBedCount;

                double bookedPercentage = totalBedCount == 0
                                ? 0
                                : (bookedCount * 100.0)
                                                / totalBedCount;
                ...
                PieChart.Data available = new PieChart.Data(
                                "Available",
                                availableCount);

                PieChart.Data booked = new PieChart.Data(
                                "Booked",
                                bookedCount);
                 ...
                 * new Label("100");
                 */
                Label total = new Label(String.valueOf(totalBedCount));
                ...
                Label totalBeds = new Label("Total Beds");
        ...
        private VBox createLabPanel() {
                ...
                TableView<LabReport> table = new TableView<>();

                TableColumn<LabReport, String> patient = new TableColumn<>("Patient");

                TableColumn<LabReport, String> test = new TableColumn<>("Test");

                TableColumn<LabReport, String> date = new TableColumn<>("Date");

                TableColumn<LabReport, String> status = new TableColumn<>("Status");
                ...
                LabrecordsController controller = new LabrecordsController();

                List<Labrecords> labrecords = controller.getAllLabrecords();
                ...
                table.setRowFactory(
                                tv -> {
                                        ...
                                        TableRow<LabReport> row = new TableRow<>();
                ...
                status.setCellFactory(
                                column -> new TableCell<LabReport, String>() {
        ...
        private VBox createEmergencyPanel() {
                ...
                // 24/7 Badge
                Label badge = new Label("● 24/7 Emergency Support");
