...
public class AppointmentPage {
        ...
        private void createAppointmentPage() {
                ...
                TableColumn<Appointment, String> noCol = new TableColumn<>("#");

                noCol.setCellFactory(column -> new TableCell<Appointment, String>() {
                ...
                // DEPARTMENT
                TableColumn<Appointment, String> departmentCol = new TableColumn<>("Department");
                ...
                statusCol.setCellFactory(column -> new TableCell<Appointment, String>() {
                ...
                actionCol.setCellFactory(column -> new TableCell<Appointment, Void>() {
                        ...
                        private final Button feedback = new Button("★");
                ...
                FilteredList<Appointment> filteredData = new FilteredList<>(data, appointment -> true);
        ...
        private void updateTodayAppointments(
                ...
                for (Appointment appointment : data) {
                        ...
                        try {
                                ...
                                java.time.LocalDate appointmentDate = java.time.LocalDate.parse(
                                                dateText.trim(),
                                                formatter);
