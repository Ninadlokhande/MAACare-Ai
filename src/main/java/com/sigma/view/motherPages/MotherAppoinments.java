...
public class MotherAppoinments {
    ...
    private String selectedReviews =
            "256 Reviews";
    ...
    private void showAppointments(
        ...
        for (AppointmentData appointment :
                appointments) {
