...
public class Asha_profilepage {
        ...
        private static final String PHONE_ICON_SVG = "M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z";

        private static final String MAIL_ICON_SVG = "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z";

        private static final String LOCATION_ICON_SVG = "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z";

        private static final String CALENDAR_ICON_SVG = "M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2V5c0-1.1-.89-2-2-2zm0 16H5V8h14v11z";

        private static final String LOCK_ICON_SVG = "M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 3.1 3.1 3.1v2z";

        private static final String LOGOUT_ICON_SVG = "M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z";

        private static final String CAMERA_ICON_SVG = "M9 2L7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z";
        ...
        public Node getProfileContent() {
                ...
                Label mainTitle = new Label("My Profile");
                ...
                HBox ashaIdBox = createAshaIdSection();
                ...
                VBox profileContainer = new VBox(14);
        ...
        private HBox createAshaIdSection() {
                ...
                Button setIdButton = new Button("Set ASHA ID");
                ...
                setIdButton.setOnAction(e -> {
                        ...
                        AshaProfileModel firebaseProfile = controller.getAshaProfile(
                                        sessionAshaId);
        ...
        private void loadProfileFromFirebase(
                ...
                try {
                        ...
                        profile = controller.getAshaProfile(
                                        ashaId);
        ...
        private void buildProfileUI(
                ...
                SVGPath userAvatarIcon = createSvgPath(
                                USER_ICON_SVG,
                                "#FFFFFF",
                                1.5);
                ...
                HBox idBadgeBox = new HBox(8);

                idBadgeBox.setAlignment(
                                Pos.CENTER_LEFT);

                Label ashaId = new Label(
                                "ASHA ID: " +
                                                profile.getAshaId());
                ...
                SVGPath infoIcon = createSvgPath(
                                USER_ICON_SVG,
                                PRIMARY_PINK,
                                0.8);
                ...
                HBox passCard = createActionCard(
                                LOCK_ICON_SVG,
                                "Change Password",
                ...
                HBox logoutCard = createActionCard(
                                LOGOUT_ICON_SVG,
                                "Logout",
        ...
        private void showEditProfileDialog(
                ...
                TextField dateogjoining = new TextField(
                                profile.getDateOfJoining());
                ...
                Button save = (Button) dialog.getDialogPane()
                                .lookupButton(
                                                saveButton);
                ...
                save.addEventFilter(
                                ...
                                event -> {
                                        ...
                                        AshaProfileModel updatedProfile = controller.getAshaProfile(
                                                        sessionAshaId);
        ...
        private void refreshProfilePage() {
                ...
                if (rootBox.getChildren().size() > 2) {
                        ...
                        oldNode = rootBox.getChildren().get(2);
                }

                VBox newContainer = new VBox(14);
        ...
        private void showChangePasswordDialog() {
                ...
                Button update = (Button) dialog.getDialogPane()
                                .lookupButton(
                                                updateButton);
        ...
        private HBox createInfoRow(
                ...
                StackPane leftIconBg = new StackPane();

                Circle circle = new Circle(
                                14,
                                Color.web("#F1F5F9"));

                SVGPath leftIcon = createSvgPath(
                                svgPathData,
                                themeColor,
                                0.7);
